...
Route::get('/printpage', [\App\Http\Controllers\ContactController::class, 'contactprint'])->name('contacts.printpage');
Route::get('/truncate', [\App\Http\Controllers\ContactController::class, 'truncatetable'])->name('contacts.truncatetable');

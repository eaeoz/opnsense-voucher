        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('contacts.index')" :active="request()->routeIs('contacts.index')">
                        {{ __('OpnSense Wifi Access Voucher Printer') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <x-dropdown align="right" width="48">
                 ...
                 @else
                    <a href="{{ route('login') }}" class="text-sm text-gray-700 underline dark:text-gray-500 hidden">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline dark:text-gray-500 hidden">Register</a>
                        @endif
                @endauth
            </div>
